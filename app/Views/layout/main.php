...
<div class="min-h-screen lg:flex">
    <aside class="fixed lg:static inset-y-0 left-0 z-40 w-[220px] bg-white border-r border-lo-border flex flex-col transition-transform duration-200"
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 text-sm">
            ...
            <a href="<?= e(url('/pedidos-web')) ?>" class="<?= $itemBase ?> <?= isActive('/pedidos-web') ? 'bg-lo-blueSoft text-lo-blue border-lo-blue' : 'text-slate-600 hover:bg-slate-50 border-transparent' ?>"><i data-lucide="globe" class="h-4 w-4"></i><span>Pedidos Web</span></a>
